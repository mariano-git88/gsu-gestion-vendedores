"""
cambios_credito.py — Registro de actualizaciones del Scoring Crediticio.
...
**El contenido vive en `cambios_credito.json`, no en este archivo, y es a
...
una entrada ARRIBA de la lista en `cambios_credito.json`. La fecha y la hora
...
ARCHIVO = Path(__file__).resolve().parent / "cambios_credito.json"
