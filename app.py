...
# CSS local del dashboard: destaca la PRIMERA tab (Asistente) con borde
# naranja permanente que la diferencia del resto. El estilo general de
# tabs (pill, fondo gris, activa con fondo naranja + bold) vive en
# `theme.py` y aplica a los 3 apps. Si reordenás, ajustar `nth-child(1)`.
st.markdown(
    """
    <style>
